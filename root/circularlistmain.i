...
# 4 "circularlistmain.c" 2
void main()
{
        struct Node* head=
# 6 "circularlistmain.c" 3 4
                         ((void *)0)
# 6 "circularlistmain.c"
                             ;
        addnode(&head,18);
        addnode(&head,27);
        addnode(&head,35);
        ...
        while(current!=
# 13 "circularlistmain.c" 3 4
                      ((void *)0)
# 13 "circularlistmain.c"
                          ){
